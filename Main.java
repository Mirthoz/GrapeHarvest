...
public class Main {
    ...
    public static void startGame(String[][] frame) {
        ...
        while (time != 0) {
            ...
            if (grapePositionX1 == basketPositionX && grapePositionY1 == basketPositionY){    //Score equals
                score++;
            }

            if (grapePositionX2 == basketPositionX && grapePositionY2 == basketPositionY){
                score++;
            }

            if (grapePositionX3 == basketPositionX && grapePositionY3 == basketPositionY){
                score++;
            }

            if (grapePositionX4 == basketPositionX && grapePositionY4 == basketPositionY){
                score++;
            }

            if (grapePositionX5 == basketPositionX && grapePositionY5 == basketPositionY){
                score++;
            }

            frame[grapePositionY1][grapePositionX1] = " o ";         //Create grape
            ...
            if (grapePositionY1 != 0) {                              //Clean after grape
            ...
            if (grapePositionY2 < frame.length - 1) {
                grapePositionY2+= 2;
            } else {
                grapePositionY2 = 0;
            ...
            if (grapePositionY3 < frame.length - 1) {
                grapePositionY3++;
            } else {
                grapePositionY3 = 0;
            ...
            if (grapePositionY4 < frame.length - 1) {
                grapePositionY4+= 2;
            } else {
                grapePositionY4 = 0;
            ...
            if (grapePositionY5 < frame.length - 1) {
                grapePositionY5++;
            } else {
                grapePositionY5 = 0;
            ...
            frame[frame.length - 1][basketPositionX] = "\\_/";     //Print basket
